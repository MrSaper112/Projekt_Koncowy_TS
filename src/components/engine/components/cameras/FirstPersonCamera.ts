...
export default class FirstPersonCamera extends Figure {
    ...
    constructor(data: { fov?: number, aspect?: number, zNear?: number, zFar?: number, acceleration?: number, keys?: Keys, aroundSpeed?: number }, vector?: Vector3D, scale?: Vector3D, rotation?: Vector3D) {
    ...
    generateMatrixOfView() {
        ...
        this._modelMatrix = this._matrix4D.translate(this._modelMatrix, this.scaleX, this.scaleY, -this.scaleZ)
